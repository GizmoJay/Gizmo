...
class Creator {
    ...
    savePlayerData (collection, player) {
        Creator.getPlayerData(player, (data) => {
            collection.updateOne({
                ...
                if (error) { log.error(`An error has occurred while saving player_data for ${player.username}!`); }
    ...
    savePlayerEquipment (collection, player) {
        collection.updateOne({
            ...
            if (error) { log.error(`An error has occurred while saving player_equipment for ${player.username}!`); }
    ...
    savePlayerQuests (collection, player) {
        collection.updateOne({
            ...
            if (error) { log.error(`An error has occurred while saving player_quests for ${player.username}!`); }
    ...
    savePlayerAchievements (collection, player) {
        collection.updateOne({
            ...
            if (error) { log.error(`An error has occurred while saving player_achievements for ${player.username}!`); }

            if (!result) { log.error(`Could not save player_achievements for ${player.username}!`); }
        });
    }
    ...
    savePlayerBank (collection, player) {
        collection.updateOne({
            ...
            if (error) { log.error(`An error has occurred while saving player_bank for ${player.username}!`); }
    ...
    savePlayerRegions (collection, player) {
        collection.updateOne({
            ...
            if (error) { log.error(`An error has occurred while saving player_regions for ${player.username}!`); }
    ...
    savePlayerAbilities (collection, player) {
        collection.updateOne({
            ...
            if (error) { log.error(`An error has occurred while saving player_abilities for ${player.username}!`); }
    ...
    savePlayerInventory (collection, player, callback) {
        collection.updateOne({
            ...
            if (error) { log.error(`An error has occurred while saving player_inventory for ${player.username}!`); }
