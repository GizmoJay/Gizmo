    ...
    getInventory (player, callback) {
        ...
        self.database.getDatabase((database) => {
            ...
            cursor.toArray().then((inventoryArray) => {
                ...
                if (info) {
                    if (info.username !== player.username) { log.notice("[Loader] Mismatch in usernames whilst retrieving inventory data for: " + player.username); }
    ...
    getBank (player, callback) {
        ...
        self.database.getDatabase((database) => {
            ...
            cursor.toArray().then((bankArray) => {
                ...
                if (info) {
                    if (info.username !== player.username) { log.notice("[Loader] Mismatch in usernames whilst retrieving bank data for: " + player.username); }
    ...
    getQuests (player, callback) {
        ...
        self.database.getDatabase((database) => {
            ...
            cursor.toArray().then((questArray) => {
                ...
                if (info) {
                    if (info.username !== player.username) { log.notice("[Loader] Mismatch in usernames whilst retrieving quest data for: " + player.username); }
    ...
    getAchievements (player, callback) {
        ...
        self.database.getDatabase((database) => {
            ...
            cursor.toArray().then((achievementsArray) => {
                ...
                if (info) {
                    if (info.username !== player.username) { log.notice("[Loader] Mismatch in usernames whilst retrieving achievement data for: " + player.username); }
