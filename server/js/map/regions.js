...
class Regions {
    ...
    loadDoors () {
        ...
        _.each(doors, (door) => {
            ...
            if (regionId in self.linkedRegions) { self.linkedRegions[regionId].push(linkedRegionPosition); } else { self.linkedRegions[regionId] = [linkedRegionPosition]; }
        });
    }
